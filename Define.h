...
enum OBJID { PLAYER, BERSERKER, RANGER, TANKER,PLAYER_BULLET, MONSTER_BULLET,SKILL, DOOR, SELECT_DOOR, LAMB, HP_BAR,  MONSTER, BOSS, ITEM, INVENTORY, BUTTON,  OBJID_END };
//ARROW,SKILL,
enum RENDERID {BACKGROUND, UI,GAMEOBJECT, EFFECT, SUPER_UI, RENDER_END };

enum SCENEID { SC_MENU, SC_EDIT, SC_LOBBY, SC_MAP, SC_STAGE, SC_FIELD, SC_Result, SC_END };
...
enum class BONEKNIGHTITEM	{ STAFF, SWORD, AXE, BOW, ARMOR, ACC, ITEM_END};
