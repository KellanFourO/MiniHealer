    ...
    _In_ int       nCmdShow)    // 실행한 창의 스타일(모양 / 최소화 모양 등)에 해당하는 인자값 
{
    ...
    LoadStringW(hInstance, IDC_MINIHEALER, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_MINIHEALER));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_MINIHEALER));
